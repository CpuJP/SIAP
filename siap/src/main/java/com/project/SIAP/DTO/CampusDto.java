...
/**
 * A DTO for the {@link com.project.SIAP.entities.Campus} entity
 */
public class CampusDto implements Serializable {
    ...
    public CampusDto(Integer id, Instant fechaIngreso, Instant fechaSalida) {
        this.id = id;
