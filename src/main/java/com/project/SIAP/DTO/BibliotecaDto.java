...
/**
 * A DTO for the {@link com.project.SIAP.entities.Biblioteca} entity
 */
public class BibliotecaDto implements Serializable {
    ...
    public BibliotecaDto(Integer id, Instant fechaIngreso, Instant fechaSalida) {
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        BibliotecaDto entity = (BibliotecaDto) o;
